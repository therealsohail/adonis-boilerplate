...
class BlogController extends BaseController {
  ...
  async index(ctx) {
    ...
    return ctx.response.json(
      this.globalResponse(true, "Record fetched successfully!", res)
    );
  }
  ...
  async store(ctx) {
    ...
    return ctx.response.json(
      this.globalResponse(true, "Record created successfully!", res)
    );
  }
  ...
  async update(ctx) {
    ...
    if (!res) {
      ...
      return ctx.response.json(
        this.globalResponse(true, "Record updated successfully!", res)
      );
    }
  }
  ...
  async destroy(ctx) {
    ...
    if (!res) {
      ...
      return ctx.response.json(
        this.globalResponse(true, "Record deleted successfully!")
      );
    }
  }
}
